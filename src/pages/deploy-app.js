            ...
            >
              <div className="hw-left">
                <h1 className="hero-heading">
                  <span className="text-gradient">App</span> Launching Soon
                </h1>
                <p className="home-desc">
                  Cyborg Connect helps AI apps deploy pre-trained models
                  instantly across our global network of hyperlocal AI
                  accelerators — delivering lightning-fast processing and
                  ultra-low latency for your users.
                </p>
                <Button
                  title="Notify Me"
