          ...
          <div className="legal-content">
            ...
            <ul>
              <li>
                ...
                voluntarily provide when you sign up for our services, contact
                us, or make a purchase.
              </li>
              <li>
                <strong>Usage Data:</strong> We may collect information about
                how you interact with our website, such as your IP address,
                browser type, pages viewed, time spent on the site, and other
                analytical data.
              </li>
              <li>
                <strong>Cookies and Tracking Technologies:</strong> We use
                cookies and similar tracking technologies to track the activity
                on our site and to retain certain information. Cookies help us
            ...
            <ul>
              ...
              <li>
                To notify you about changes to our services or any updates.
              </li>
              ...
              <li>
                To send you promotional content, newsletters, or other marketing
            ...
            <ul>
              <li>
                ...
                operate our website, conduct business, or provide services to
                you. These providers are contractually obligated to handle your
                data securely and only for the purpose of assisting us.
              </li>
              <li>
                <strong>Legal Requirements:</strong> We may disclose your
                information if required to do so by law or in response to a
                valid legal request, such as a subpoena or government
                investigation.
              </li>
              <li>
                <strong>Business Transfers:</strong> In the event of a merger,
                acquisition, or asset sale, your information may be transferred
                as part of that transaction. You will be notified of any such
            ...
            <p>
              ...
              under the age of 13, we will take steps to delete that information
              as soon as possible.
            </p>
            <h2>6. Children's Privacy</h2>
            <p>
            ...
            <p>
              ...
              top of the page will be revised accordingly. We encourage you to
