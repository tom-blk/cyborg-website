            ...
            >
              <div className="hw-left">
                <h1 className="hero-heading">
                  <span className="text-gradient">Pre-sale</span> Coming Soon
                </h1>
                <p className="home-desc">
                  Turn compute into income. Cyborg Miner lets you run AI
                  inference tasks from your space and earn rewards — no crypto
                  mining, just real utility powering the next-gen AI economy. Be
                  the infrastructure behind the next generation of intelligent
                  apps. Plug in. Power up. Get rewarded.
                </p>
                <Button
                  title="Notify Me"
