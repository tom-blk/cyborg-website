            ...
            >
              <div className="sw-left">
                <div className="sw-detail">
                  <h2>Mission</h2>
                  <p>
                    To revolutionize AI infrastructure by integrating blockchain
                    and edge computing, creating scalable, secure, and efficient
                    AI hubs. Our goal is to empower businesses and developers
                    with seamless access to high-performance AI, driving
            ...
            >
              <div className="sw-right">
                <div className="sw-detail">
                  <h2>Vision</h2>
                  <p>
                    To be the market leader in future tech infrastructure,
                    laying the foundation for next-generation AI, decentralized
                    computing, and autonomous systems, shaping a smarter, more
                    connected world.
                  </p>
                </div>
              </div>
      ...
      <section className="common-section team-section">
        <div className="container">
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, translateY: 0 }}
          >
            Innovators and problem-solvers, driven by determination and
            perseverance. We tackle challenges head-on, shaping the future of AI
            infrastructure with passion and expertise.
          </motion.p>
          <div className="tsx-wrap">
            <div className="tsx-main">
              ...
              >
                ...
                <Link
                  href="https://www.linkedin.com/in/barath-kanna/"
                  target="_blank"
                  className="tsx-link"
                >
                  <Linkedin />
              ...
              >
                ...
                <Link
                  href="https://www.linkedin.com/in/megha-varshini-t/ "
                  target="_blank"
                  className="tsx-link"
                >
                  <Linkedin />
            ...
            <div className="tsx-sub">
              ...
              >
                <div className="tsx-img">
                  ...
                  <Link
                    href="https://www.linkedin.com/in/tom-bleek-a7332b182/"
                    target="_blank"
                    className="tsx-link"
                  >
                    <Linkedin />
              ...
              >
                <div className="tsx-img">
                  ...
                  <Link
                    href="https://www.linkedin.com/in/nikunj-galaiya-625575351/"
                    target="_blank"
                    className="tsx-link"
                  >
                    <Linkedin />
              ...
              >
                <div className="tsx-img">
                  ...
                  <Link
                    href="https://www.linkedin.com/in/akashsingh9759/ "
                    target="_blank"
                    className="tsx-link"
                  >
                    <Linkedin />
